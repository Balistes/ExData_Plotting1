...
if( !file.exists("./data")) {
  ...
  # read data
  hpcset <- read.table(file.path("./data","household_power_consumption.txt"), header=TRUE, 
...
# create graph of Energy Sub metering (~Time)
plot(workset$Time, workset$Sub_metering_1, type="l", ylab= "Energy sub metering", xlab="")
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
       pch = , lty=1, cex = 0.85, 
       col=c("black", "red", "blue"), xjust=0, yjust=0, bty = "o")
